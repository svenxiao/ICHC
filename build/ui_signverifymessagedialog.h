...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        horizontalLayout_1_SM->setSpacing(20);
        ...
        addressIn_SM->setMinimumSize(QSize(0, 32));
        addressIn_SM->setMaximumSize(QSize(16777215, 32));
        ...
        addressBookButton_SM->setMinimumSize(QSize(62, 32));
        addressBookButton_SM->setMaximumSize(QSize(62, 32));
        QIcon icon;
        ...
        pasteButton_SM->setMinimumSize(QSize(62, 32));
        pasteButton_SM->setMaximumSize(QSize(62, 32));
        QIcon icon1;
        ...
        horizontalLayout_2_SM->setSpacing(20);
        ...
        signatureOut_SM->setMinimumSize(QSize(0, 32));
        signatureOut_SM->setMaximumSize(QSize(16777215, 32));
        QFont font;
        font.setItalic(true);
        ...
        copySignatureButton_SM->setMinimumSize(QSize(62, 32));
        copySignatureButton_SM->setMaximumSize(QSize(62, 32));
        QIcon icon2;
        ...
        horizontalLayout_1_VM->setSpacing(20);
        ...
        addressIn_VM->setMinimumSize(QSize(0, 32));
        addressIn_VM->setMaximumSize(QSize(16777215, 32));
        ...
        addressBookButton_VM->setMinimumSize(QSize(62, 32));
        addressBookButton_VM->setMaximumSize(QSize(62, 32));
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this ICHC address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified ICHC address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
