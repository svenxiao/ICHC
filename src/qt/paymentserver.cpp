...
const QString BITCOIN_IPC_PREFIX("ICH-C:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click ICH-C: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start ICH-C: click-to-pay handler");
    else
...
{
    // clicking on ICH-C: URLs creates FileOpen events on the Mac:
